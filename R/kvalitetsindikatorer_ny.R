...
#' (datagrunnlaget) for den aktuelle indikatorer, den andre variabelnen
...
#' \itmeize{
#' \item nevner \code{indikator_komplikasjon_data} (datagrunnlag) er \emph{ja}
#'  for alle ferdigstilte skjema og \emph{nei} for ikke-ferdigstilte skjema.
#' \item teller \code{indikator_komplikasjon} er \emph{ja} dersom
...
#' utvalgte variabler, avhenger av hvilke indikator som skal regnes ut. F.eks.
