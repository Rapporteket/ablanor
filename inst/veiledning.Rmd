...
### Kodebok
Her kan du laste inn forklaringstekster for alle variabler i de ulike tabellene
som er tilgjengelige i Utforsker. Kodeboken er søkbar. Variabler markert med 
Skjemanavn _utledete_variabel_ betyr at variabelen ikke finnes i databasen, men 
er utledet på grunnlag av variabler i databasen. 
