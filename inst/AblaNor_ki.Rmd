...
cap <- paste0("AFLI prosedyrer uten AV-knuter/HIS ablasjon. ", 
              "Forløp der akutt suksess er lik 'Ikke aktuelt' er fjernet fra ", 
              "datagrunnlaget. ",
              "Tabellen viser antall (andel) forløp med akutt suksess ", 
              "fra hele fjoråret og hittil i år (t.o.m. ", 
              siste_dato_txt, ").")
...
```{r akuttSuksessAfliFig, fig.cap = figtekst, fig.width = 8, fig.height = 4, fig.pos = "H", fig.align = "center", out.width = "\\textwidth"}



figtekst <- paste0("AFLI prosedyrer uten AV-knuter/HIS ablasjon. ", 
              "Forløp der akutt suksess er lik 'Ikke aktuelt' er fjernet fra ", 
              "datagrunnlaget. ",
              "Figuren viser andel forløp med akutt suksess ", 
              "fra hele fjoråret og hittil i år (t.o.m. ", 
              siste_dato_txt, ") for ", 
              lokaltSykehus, " og nasjonalt. ", 
              "Målnivået viser i farge.")
...
p1 <- p1 +
    ...
    ggplot2::geom_line(
      data = d_akuttS %>% dplyr::filter(indik_akuttsuksess_data %in% "AFLI"),
   ...
   ggplot2::scale_color_manual(
        name = "",
        values = c(colKontrast, colPrimary[3]), 
