...
```{r typeForlopFig, fig.cap = paste("Fordeling av forløpstyper registrert de ", showN," siste månedene."), fig.width = 20, fig.height = 10, fig.pos = "H", fig.align = "center", out.width = "\\textwidth" }
